...
def obtener_datos():
    ...
    consulta = """
    SELECT
        detalles_ropa.id_ropa AS id,
        detalles_ropa.nombre_ropa AS prenda,
        detalles_ropa.img_ropa AS img,
        detalles_ropa.precio_ropa AS precio,
        GROUP_CONCAT(talles_ropa.talle_ropa) AS talles,
        tipo_ropa.ropa_para
    FROM detalles_ropa
    ...
    WHERE detalles_talles.validacion_talle = 1
